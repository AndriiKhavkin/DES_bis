 ...
 namespace DES_bis
 {
     class Program
     {
        ...
        { 
            ...
            BitArray block64_1 = IntToBitArray(text1, 64);
            BitArray key64_1 = IntToBitArray(key1, 64);
            BitArray test64_1 = IntToBitArray(code1, 64);
            BitArray result1 = DES(block64_1, key64_1);

            BitArray block64_2 = IntToBitArray(text2, 64);
            BitArray key64_2 = IntToBitArray(key2, 64);
            BitArray test64_2 = IntToBitArray(code2, 64);
            BitArray result2 = DES(block64_2, key64_2);

            BitArray block64_3 = IntToBitArray(text3, 64);
            BitArray key64_3 = IntToBitArray(key3, 64);
            BitArray test64_3 = IntToBitArray(code3, 64);
            BitArray result3 = DES(block64_3, key64_3);
            ...
            PrintHex(key64_1);
            Console.Write("\nResult:");
            PrintHexXReverse(result1);
            Console.Write("\nExpected:");
            PrintHexXReverse(test64_1);
            ...
            PrintHex(key64_2);
            Console.Write("\nResult:");
            PrintHexXReverse(result2);
            Console.Write("\nExpected:");
            PrintHexXReverse(test64_2);
            ...
            PrintHex(key64_3);
            Console.Write("\nResult:");
            PrintHexXReverse(result3);
            Console.Write("\nExpected:");
            PrintHexXReverse(test64_3);
            ...
            BitArray bitOfPassword = IntToBitArray(intPassword, 64);
            BitArray bitOfName = IntToBitArray(intName, 64);
            BitArray result = EncryptionDES(bitOfName, bitOfPassword);

            Console.WriteLine("\n\nTest 4");
            Console.Write("Name:");
            PrintHex(bitOfName);
            Console.Write("\nPassword:");
            PrintHex(bitOfPassword);
            Console.Write("\nResult:");
            PrintHexXReverse(result);
            Console.WriteLine("\nPress enter to exit...");
            Console.ReadLine();
        }
        ...
        static BitArray DES(BitArray block_64, BitArray key_64)
         {
        ...
        static BitArray GetLeft(BitArray block64)
         {
         ...
         static BitArray GetRight(BitArray block64)
         {
         ...
         static BitArray JoinLeftRight(BitArray left, BitArray right)
         {
         ...
         static BitArray EncryptionDES(BitArray block64, BitArray key48)
         {
        ...
        static BitArray[] key0CD(BitArray key_64)
         {
         ...
         static BitArray UniteCD(BitArray C, BitArray D)
         {
        ...
        static BitArray KeyFromCD(BitArray C, BitArray D)
         {
         ...
         static BitArray ShiftToLeft(BitArray bits)
         {
        ...
        static BitArray change_8ths(BitArray key)
         {
             int count;
             for (int i = 0; i < 8; i++)
             {
        ...
        static BitArray InitialPermutation(BitArray block)
         {
             int[] orderOfMixing =
             {
        ...
        static BitArray FinalPermutation(BitArray block)
         {
             int[] orderOfMixing =
             {
        ...
        static BitArray Expansion48(BitArray block)
         {
             int[] orderOfMixing =
             {
                 32, 1, 2, 3, 4, 5, 4, 5,
        ...
        static BitArray Function(BitArray block_32, BitArray key_48)
        {
        ...
        static BitArray FeistelFunction(BitArray block)
         {
             int[] orderOfMixing =
             {
        ...
        static BitArray S1(BitArray block1)
        {
        ...
        static BitArray S2(BitArray block6)
        {
        ...
        static BitArray S3(BitArray block6)
        {
        ...
        static BitArray S4(BitArray block6)
        {
        ...
        static BitArray S5(BitArray block6)
        {
        ...
        static BitArray S6(BitArray block6)
        {
        ...
        static BitArray S7(BitArray block6)
        {
        ...
        static BitArray S8(BitArray block6)
        {
        ...
        static BitArray IntToBitArray(int num, int length)
         {
